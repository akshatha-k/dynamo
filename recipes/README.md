...
| **[A.X-K2-NVFP4](ax-k2-nvfp4/)** | vLLM | Aggregated | 8x B200 | ✅ | ✅ | Two TP4/DP1 workers with EP disabled, NVFP4 + FP8 KV, sparse MLA, KV-aware routing; 8K/1K Mooncake chat trace | ❌ |
