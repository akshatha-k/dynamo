...
| **[A.X-K2-NVFP4](ax-k2-nvfp4/)** | vLLM | Aggregated / Disaggregated | 8x / 12x B200 | ✅ | ✅ | Two TP4 aggregate workers or 2P1D TP4 over NIXL; prefill async disabled in 2P1D, EAGLE3 k=3 on both roles, NVFP4 + FP8 KV, sparse MLA, KV-aware routing | ❌ |
