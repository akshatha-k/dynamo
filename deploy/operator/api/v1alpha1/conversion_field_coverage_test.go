...
DynamoComponentDeploymentSpec.experimental.checkpoint.enabled
...
DynamoComponentDeploymentSpec.providerOverride.apiVersion
DynamoComponentDeploymentSpec.providerOverride.target
DynamoComponentDeploymentSpec.providerOverride.value
DynamoComponentDeploymentSpec.replicas
DynamoComponentDeploymentSpec.roles.name
DynamoComponentDeploymentSpec.roles.podTemplate
...
DynamoComponentDeploymentStatus.component.gpusPerEngine
DynamoComponentDeploymentStatus.component.gpusPerReplica
DynamoComponentDeploymentStatus.component.readyReplicas
DynamoComponentDeploymentStatus.component.replicas
DynamoComponentDeploymentStatus.component.runtimeNamespace
DynamoComponentDeploymentStatus.component.scheduledReplicas
...
DynamoGraphDeploymentSpec.components.experimental.checkpoint.enabled
...
DynamoGraphDeploymentSpec.components.providerOverride.apiVersion
DynamoGraphDeploymentSpec.components.providerOverride.target
DynamoGraphDeploymentSpec.components.providerOverride.value
DynamoGraphDeploymentSpec.components.replicas
DynamoGraphDeploymentSpec.components.roles.name
DynamoGraphDeploymentSpec.components.roles.podTemplate
...
DynamoGraphDeploymentSpec.experimental.kvTransferPolicy.clusterTopologyName
...
DynamoGraphDeploymentSpec.providerOverride.apiVersion
DynamoGraphDeploymentSpec.providerOverride.target
DynamoGraphDeploymentSpec.providerOverride.value
...
DynamoGraphDeploymentStatus.components.gpusPerEngine
DynamoGraphDeploymentStatus.components.gpusPerReplica
DynamoGraphDeploymentStatus.components.readyReplicas
DynamoGraphDeploymentStatus.components.replicas
DynamoGraphDeploymentStatus.components.runtimeNamespace
DynamoGraphDeploymentStatus.components.scheduledReplicas
